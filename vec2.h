...
MATHAPI vec2 vec2Init(const float, const float);


MATHAPI vec2 vec2Copy(const vec2);
...
MATHAPI vec2 vec2Add(const vec2, const vec2);


MATHAPI vec2 vec2Addf(const vec2, const float);


MATHAPI vec2 vec2Sub(const vec2, const vec2);


MATHAPI vec2 vec2Subf(const vec2, const float);


MATHAPI vec2 vec2Mul(const vec2, const vec2);


MATHAPI vec2 vec2Mulf(const vec2, const float);


MATHAPI vec2 vec2Div(const vec2, const vec2);


MATHAPI vec2 vec2Divf(const vec2, const float);


MATHAPI int vec2Equals(const vec2, const vec2);


MATHAPI vec2 vec2Pow(const vec2, float);


MATHAPI vec2 vec2Pow2(const vec2);


MATHAPI vec2 vec2Sqrt(const vec2);


MATHAPI vec2 vec2Clamp(const vec2, const vec2, const vec2);


MATHAPI vec2 vec2Clampf(const vec2, float, float);


MATHAPI vec2 vec2Clamp01(const vec2);


MATHAPI float vec2Distance(const vec2, const vec2);


MATHAPI float vec2Length(const vec2);


MATHAPI float vec2Dot(const vec2, const vec2);


MATHAPI vec2 vec2Normalize(const vec2);


MATHAPI vec2 vec2Scale(const vec2, const float);


MATHAPI const float *vec2Ptr(const vec2 *);


MATHAPI const char *vec2String(const vec2);
...
MATHAPI int vec2Equals(const vec2 v0, const vec2 v1) {
